        ...
        <div className="min-h-screen bg-gray-100">
            <nav style={{ backgroundColor: globalVars.info == null ? 'gray' : globalVars.info.color_pagina }} >
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 md:-my-px md:ml-10 md:flex ">
                                <div className='rounded' style={{ zIndex: '9', marginTop: '1.1em', borderRadius: '15px', marginRight: '-1em' }} >
                                    <button style={{ color: 'white', fontSize: '1.2em' }} className="peer inline-flex items-center px-3 py-2 leading-4 font-medium rounded-md focus:outline-none transition ease-in-out duration-150">
                                        Productos
                                    ...
                                    <div style={{ borderRadius: '15px' }} className="hidden peer-hover:flex hover:flex flex-col bg-white drop-shadow-lg">
                                        <a href={route('product.index')} style={{ color: 'black', padding: '0.5em' }} className="tamañoLetraNav btn btn-outline-light text-left hover:bg-gray-200" >Productos</a>
                                        <a href={route('category.index')} style={{ color: 'black', padding: '0.5em' }} className="tamañoLetraNav btn btn-outline-light text-left hover:bg-gray-200" >Categorias</a>
                                        <a href={route('topping.list', 'nothing')} style={{ color: 'black', padding: '0.5em' }} className="tamañoLetraNav btn btn-outline-light text-left hover:bg-gray-200" >Toppings</a>
                                    </div>
                ...
                <div style={{ marginLeft: '0.5em' }} className={(showingNavigationDropdown ? 'block' : 'hidden') + ' md:hidden'}>
                    ...
                    <div className="pt-2 pb-3 space-y-1">
                        <NavLink href={route('topping.list', 'nothing')} active={route().current('topping.list')}>
                            Toppings
                        </NavLink>
                    </div>
                    <div className="pt-2 pb-3 space-y-1">
