        ...
        <div className="row">
            ...
            <div id="div_miniaturas" className="row col-lg-2 col-md-2 col-sm-3 col-3" style={{ textAlign: 'center' }} >
                ...
                {params.categorias.map((item, index) => {
                    return (
                        <div key={index} id={'divMin' + index} onClick={() => cambiarCategoria(item, index)} className="col-lg-2 col-md-12 col-sm-3 col-3" style={{ height: '4em', width: '7em', margin: '20px', cursor: 'pointer', marginLeft: '0.3em' }}>
                            <img className="img-fluid img-thumbnail" style={{ height: '100%', width: '100%' }} src={params.globalVars.urlImagenesCategorias + item.imagen} />
                                ...
                                return (
                                    <div onClick={() => seleccionarProducto(img, item)} key={index} style={{ marginBottom: '1em' }} className="col-lg-4 col-md-4 col-sm-6 col-6"  >
                                        <div className="card border card-flyer pointer">
                                            <img style={{ maxWidth: '14em', maxHeight: '10em', marginTop: '1em', padding: '1em' }} src={img} className="card-img-top img-fluid centerImg" alt="" />
