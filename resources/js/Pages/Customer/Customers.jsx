                    ...
                    <div className="col-12">
                        <form>
                            <div className="flex items-center py-3">
                                <input size="44" id='inputBuscar' onClick={buscarClientesCompletos} onChange={cambioNombre} className="rounded py-2" type="text" placeholder="Buscar clientes..." aria-label="Full name" />
